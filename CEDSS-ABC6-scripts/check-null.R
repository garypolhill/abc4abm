...
data$null.newsubcatapp <- (data$newsubcatapp == 1)
data$null.newsubcatstep <- (as.character(data$newsubcatstep) == "max")
...
data$none.null <- (!(data$null.bioboost
		     ...
		     | data$null.planning2
		     | data$null.visits))
# N.B. Deliberately don't include data$null.newsubcatapp here
